...
public class ItemService {
    ...
    /**
     * Combined dashboard search: keyword, location, status and the date
     * range can each be present or absent independently, and whichever are
     * present are ANDed together. Blank strings are treated as "not provided".
     */
